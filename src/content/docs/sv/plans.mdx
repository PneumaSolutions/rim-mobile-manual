...
Vem som helst kan använda RIM för att hjälpa en annan användare i upp till 30 minuter per dag. Dessa minuter behöver inte användas på en gång, och en användningsmätare håller koll på hur många minuter du har varje dag. Under dina 30 minuter kan du ansluta till valfritt antal personer, under valfritt antal interaktiva sessioner. Efter varje session kommer RIM att visa en popup-påminnelse med din återstående tid, samt en "Registrera dig för betalda RIM-tjänster"-knapp.  
<MacOS>
Om du trycker på escape i detta popup-fönster kan det i vissa fall resultera i en tom skärm där VoiceOver meddelar att Remote Incident Manager inte har några fönster. Om detta skulle inträffa kan du helt enkelt *Kommando+Tab* till valfri applikation. Var försiktig så att du inte trycker på Command+Q, annars kommer du inte att kunna starta om RIM med tangentbordskommandot *Option+Shift+Backspace* förrän du startar om RIM manuellt.
</MacOS>
...
RIM Personal Weekend Support-abonnemanget är avsett för personer som vill erbjuda fjärrsupport till familj, vänner eller medlemmar i sin omgivning under helgen. Det ger obegränsad RIM-uppkopplingstid för sessioner via nyckelord på lördagar och söndagar, utöver de 30 minuter per dag på vardagar som ingår i gratispaketet. Observera att detta abonnemang inte inkluderar obevakad åtkomst.
...
Om du köper flera förbetalda artiklar, t.ex. pass eller timpaket, får du en separat aktiveringslänk för varje artikel. Detta innebär att till exempel två separata pass kan aktiveras på två separata konton. Detta är användbart i situationer där du vill ge bort en av posterna i ett större köp.