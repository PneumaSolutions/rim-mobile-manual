...
Sono finiti i tempi in cui era necessario effettuare una chiamata telefonica o una conferenza web separata per la sessione remota. RIM offre una comunicazione vocale cristallina e a bassa latenza direttamente all'interno della sessione.
...
##### Le differenze tra i lettori di schermo sono ora irrilevanti
...
* Poiché Remote Incident Manager è multipiattaforma, molte sezioni di questa documentazione si adattano al sistema operativo in uso.
    ...
    * Nel caso in cui il riconoscimento della piattaforma non avvenga o si stia leggendo la documentazione su un dispositivo diverso, come un telefono o un tablet, il manuale tornerà alla versione per Windows. Nella parte superiore e inferiore della pagina sono presenti dei pulsanti che possono essere utilizzati per visualizzare il contenuto della piattaforma scelta.
* Cambiando la lingua si accede alla sezione di benvenuto del manuale nella lingua scelta.
