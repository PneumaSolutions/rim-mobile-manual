...
You will land in an edit box labeled "keyword." Enter the keyword issued to you by the person assisting you once they give you the go ahead, and then simply hit enter. That's it, you're connected!
...
1. Lastly, you will receive another verification code on your phone. Enter this code into RIM.
    1. If you do not have a mobile phone capable of receiving text messages, please fill out [this form](https://pneumasolutions.com/account-verification/). We will assist you in getting your account verified.
...
Now that you're logged in, enter the keyword that the target will use to connect to you. When you navigate past the edit box, you will come across two checkboxes which determine whether or not to start a voice conversation or disable remote computer audio during the session (these options can be toggled on or off during the session as well). After that, you will find the "Start" button. When you click this, you will be in the waiting room until your target connects. At this point, you will want to send the keyword you just entered to the person you'll be connecting to. The keyword is valid for 5 minutes or until a successful connection is established, whichever comes first. Once they have connected, you will receive an alert informing you that the remote session is about to begin.  
<Windows>
