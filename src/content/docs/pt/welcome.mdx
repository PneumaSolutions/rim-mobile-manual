...
### Por que o RIM?
Se você vem de aplicativos de área de trabalho remota anteriores ou de ferramentas de assistência baseadas em leitores de tela, verá que o RIM simplifica significativamente o seu fluxo de trabalho.
#### Design inclusivo
O Remote Incident Manager é realmente o primeiro de seu tipo. É a primeira solução de suporte remoto *totalmente acessível* que pode ser usada por profissionais de suporte e usuários finais cegos e com visão. Portanto, o RIM pode substituir totalmente uma solução existente, pois oferece tudo o que se pode pedir em uma solução de suporte remoto seguro, além de acessibilidade total.
...
Ao contrário da Área de Trabalho Remota do Windows ou de outros aplicativos semelhantes, não é criada uma sandbox de sessão remota; o que a máquina do usuário final está fazendo é o que você verá. Isso significa que você pode solucionar facilmente um problema que ele esteja tendo, mantendo intacta a configuração existente. Isso também permite que você trabalhe de forma colaborativa em um projeto, envie arquivos de e para a área de transferência, etc.
#### Conexões rápidas e estáveis
Como a RIM usa os mais recentes avanços em conexões diretas entre computadores, a capacidade de resposta é muito superior à de outras soluções. Embora o serviço central da RIM inicie a conexão, ele sai do seu caminho depois que a conexão é estabelecida. Tudo isso sem a necessidade de fazer alterações incômodas e invasivas nas configurações de rede.
...
#### Comunicação por voz
Já se foram os dias em que era necessário fazer uma chamada telefônica ou uma conferência na Web separadamente, juntamente com a sessão remota. A RIM oferece comunicação de voz cristalina e de baixa latência diretamente em sua sessão.
...
##### As diferenças entre os leitores de tela agora são irrelevantes
...
* Como o Remote Incident Manager é multiplataforma, muitas seções desta documentação adaptarão seu conteúdo ao sistema operacional que você está executando.
    ...
    * Se o reconhecimento da plataforma falhar ou se você estiver lendo a documentação em um dispositivo diferente, como um telefone ou tablet, o manual voltará para a versão do Windows. Você encontrará botões na parte superior e inferior da página que podem ser usados para mostrar o conteúdo da plataforma de sua escolha.
* A mudança de idioma o levará à seção Bem-vindo do manual no idioma escolhido.
